...
class Border(CamScroll):
    ...
    def scroll(self):
        ...
        """self.camera.offset.y = max(self.player.down_border, self.camera.offset.y)
        self.camera.offset.y = min(self.camera.offset.x, self.player.up_border - self.camera.DISPLAY_H)"""
